...
Defined in: [packages/modelence/src/auth/client/index.ts:143](https://github.com/modelence/modelence/blob/a5e481a2d6238ded739b042ff3eb688c135a90db/packages/modelence/src/auth/client/index.ts#L143)
