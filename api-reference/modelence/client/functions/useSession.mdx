...
Defined in: [src/client/session.ts:94](https://github.com/modelence/modelence/blob/483c5a3a7481c6bc6eaa35e2d1eb018a6c7465bc/packages/modelence/src/client/session.ts#L94)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:96](https://github.com/modelence/modelence/blob/483c5a3a7481c6bc6eaa35e2d1eb018a6c7465bc/packages/modelence/src/client/session.ts#L96) |
