...
Defined in: [index.ts:108](https://github.com/modelence/modelence/blob/ea687990e12abb257c8c8d59363b739d10414fa7/packages/react-query/src/index.ts#L108)
...
| ------ | ------ | ------ |
| `queryFn()` | () => `Promise`\<`T`\> | [index.ts:114](https://github.com/modelence/modelence/blob/ea687990e12abb257c8c8d59363b739d10414fa7/packages/react-query/src/index.ts#L114) |
| `queryKey` | (`string` \| `Args`)[] | [index.ts:113](https://github.com/modelence/modelence/blob/ea687990e12abb257c8c8d59363b739d10414fa7/packages/react-query/src/index.ts#L113) |
