...
Defined in: [src/config/server.ts:13](https://github.com/modelence/modelence/blob/eb0758916af0194c0b9b05aed928d49828c2de43/packages/modelence/src/config/server.ts#L13)
