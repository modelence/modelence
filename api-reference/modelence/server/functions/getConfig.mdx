...
Defined in: [src/config/server.ts:43](https://github.com/modelence/modelence/blob/1e291847bf7c940a7fea7e34962c841bf1b5644d/packages/modelence/src/config/server.ts#L43)
