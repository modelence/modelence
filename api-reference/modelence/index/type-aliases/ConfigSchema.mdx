...
Defined in: [src/config/types.ts:17](https://github.com/modelence/modelence/blob/b983bd596c065de0b3196190ccfffab8dc768932/packages/modelence/src/config/types.ts#L17)
