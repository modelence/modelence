...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/3fae98d242d920a510c5611b305dbc4f770799d1/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/3fae98d242d920a510c5611b305dbc4f770799d1/packages/modelence/src/client/session.ts#L72) |
