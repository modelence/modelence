...
Defined in: [packages/modelence/src/auth/client/index.ts:80](https://github.com/modelence/modelence/blob/eff60a49c5827e5240a61cdee9ad715a06ff3c04/packages/modelence/src/auth/client/index.ts#L80)
