...
Defined in: [src/config/types.ts:17](https://github.com/modelence/modelence/blob/039beeaa0fd96ae23fb8ca84a7f8e5b25b9d826d/packages/modelence/src/config/types.ts#L17)
