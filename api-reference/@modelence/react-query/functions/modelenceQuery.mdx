...
Defined in: [index.ts:108](https://github.com/modelence/modelence/blob/06ef6e9500878fe6d1e5dc5484935418772f777c/packages/react-query/src/index.ts#L108)
...
| ------ | ------ | ------ |
| `queryFn()` | () => `Promise`\<`T`\> | [index.ts:114](https://github.com/modelence/modelence/blob/06ef6e9500878fe6d1e5dc5484935418772f777c/packages/react-query/src/index.ts#L114) |
| `queryKey` | (`string` \| `Args`)[] | [index.ts:113](https://github.com/modelence/modelence/blob/06ef6e9500878fe6d1e5dc5484935418772f777c/packages/react-query/src/index.ts#L113) |
