...
Defined in: [src/config/server.ts:43](https://github.com/modelence/modelence/blob/f5213e3b8c858bdbaad2e5c02be61c54907523d0/packages/modelence/src/config/server.ts#L43)
