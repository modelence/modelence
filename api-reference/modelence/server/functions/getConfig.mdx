...
Defined in: [packages/modelence/src/config/server.ts:43](https://github.com/modelence/modelence/blob/a91003f873f0064c96a4a9ffcac01cbc6ae6c39f/packages/modelence/src/config/server.ts#L43)
