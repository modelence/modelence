...
Defined in: [index.ts:108](https://github.com/modelence/modelence/blob/2696235e8e13294cee0e6f75f32149fd5d23f762/packages/react-query/src/index.ts#L108)
...
| ------ | ------ | ------ |
| `queryFn()` | () => `Promise`\<`T`\> | [index.ts:114](https://github.com/modelence/modelence/blob/2696235e8e13294cee0e6f75f32149fd5d23f762/packages/react-query/src/index.ts#L114) |
| `queryKey` | (`string` \| `Args`)[] | [index.ts:113](https://github.com/modelence/modelence/blob/2696235e8e13294cee0e6f75f32149fd5d23f762/packages/react-query/src/index.ts#L113) |
