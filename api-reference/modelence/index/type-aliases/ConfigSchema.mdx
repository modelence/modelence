...
Defined in: [src/config/types.ts:17](https://github.com/modelence/modelence/blob/d60022afccb1a974b729cb4aaaf48ac10f9a4601/packages/modelence/src/config/types.ts#L17)
