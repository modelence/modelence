...
Defined in: [src/config/types.ts:17](https://github.com/modelence/modelence/blob/55fa59c7537464f4bb0709986cc83c584efe837f/packages/modelence/src/config/types.ts#L17)
