...
Defined in: [index.ts:34](https://github.com/modelence/modelence/blob/0e0fb90bc587cbdcb5a646a5ad3721c781344656/packages/react-query/src/index.ts#L34)
...
| ------ | ------ | ------ |
| `queryFn()` | () => `Promise`\<`T`\> | [index.ts:40](https://github.com/modelence/modelence/blob/0e0fb90bc587cbdcb5a646a5ad3721c781344656/packages/react-query/src/index.ts#L40) |
| `queryKey` | (`string` \| `Args`)[] | [index.ts:39](https://github.com/modelence/modelence/blob/0e0fb90bc587cbdcb5a646a5ad3721c781344656/packages/react-query/src/index.ts#L39) |
