...
Defined in: [packages/modelence/src/auth/client/index.ts:135](https://github.com/modelence/modelence/blob/9f2ac29feebd5bf4df842b642b9537d004dffd85/packages/modelence/src/auth/client/index.ts#L135)
