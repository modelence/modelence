...
Defined in: [index.ts:242](https://github.com/modelence/modelence/blob/a89326e2c7b8f250ed9e03dd1024ca051acd35dd/packages/react-query/src/index.ts#L242)
...
| ------ | ------ | ------ |
| `mutationFn()` | (`variables`) => `Promise`\<`T`\> | [index.ts:247](https://github.com/modelence/modelence/blob/a89326e2c7b8f250ed9e03dd1024ca051acd35dd/packages/react-query/src/index.ts#L247) |
