...
Defined in: [src/config/server.ts:46](https://github.com/modelence/modelence/blob/7a3f73267b8c31a9920c7e7fb161d8f3f1849997/packages/modelence/src/config/server.ts#L46)
