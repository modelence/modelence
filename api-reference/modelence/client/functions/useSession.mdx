...
Defined in: [src/client/session.ts:94](https://github.com/modelence/modelence/blob/0b6733f929d9a9924993eb740aa6cd4a165aa17c/packages/modelence/src/client/session.ts#L94)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:96](https://github.com/modelence/modelence/blob/0b6733f929d9a9924993eb740aa6cd4a165aa17c/packages/modelence/src/client/session.ts#L96) |
