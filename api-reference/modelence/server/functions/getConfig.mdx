...
Defined in: [src/config/server.ts:43](https://github.com/modelence/modelence/blob/320d17e1ee30ad3378756fde34349a507205f95c/packages/modelence/src/config/server.ts#L43)
