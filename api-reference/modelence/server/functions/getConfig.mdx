...
Defined in: [src/config/server.ts:43](https://github.com/modelence/modelence/blob/910a4187b3dcb47ecc312c0d2e536b4b2131670d/packages/modelence/src/config/server.ts#L43)
