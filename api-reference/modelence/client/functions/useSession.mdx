...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/7665186d6c22a12a639c39f38ffe52a6b5f0255a/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/7665186d6c22a12a639c39f38ffe52a6b5f0255a/packages/modelence/src/client/session.ts#L72) |
