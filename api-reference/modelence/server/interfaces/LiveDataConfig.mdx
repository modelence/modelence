...
| ------ | ------ | ------ | ------ |
| <a id="fetch"></a> `fetch` | () => `T` \| `Promise`\<`T`\> | Fetches the current data. Called initially and whenever watch triggers publish. | [packages/modelence/src/live-query/context.ts:34](https://github.com/modelence/modelence/blob/f614ecc6811cdda9670d612872c8ff49a49c5e28/packages/modelence/src/live-query/context.ts#L34) |
