...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/8c17d7fdd3b499769efa26f653f7b9287c396618/packages/modelence/src/rate-limit/rules.ts#L30)
