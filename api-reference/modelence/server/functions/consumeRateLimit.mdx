...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/2331bd1d5c8baec696663e9fedaa9938ddb72b07/packages/modelence/src/rate-limit/rules.ts#L30)
