...
Defined in: [src/config/server.ts:13](https://github.com/modelence/modelence/blob/bd5ee85481a0319d645bc13d4023e1b5fe4c9b19/packages/modelence/src/config/server.ts#L13)
