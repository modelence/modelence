...
Defined in: [index.ts:108](https://github.com/modelence/modelence/blob/acaf180f41364e3059e4329fa7ce74158e010959/packages/react-query/src/index.ts#L108)
...
| ------ | ------ | ------ |
| `queryFn()` | () => `Promise`\<`T`\> | [index.ts:114](https://github.com/modelence/modelence/blob/acaf180f41364e3059e4329fa7ce74158e010959/packages/react-query/src/index.ts#L114) |
| `queryKey` | (`string` \| `Args`)[] | [index.ts:113](https://github.com/modelence/modelence/blob/acaf180f41364e3059e4329fa7ce74158e010959/packages/react-query/src/index.ts#L113) |
