...
Defined in: [packages/modelence/src/auth/client/index.ts:80](https://github.com/modelence/modelence/blob/2e721459f75ba11a220137d4df59b619a82a0068/packages/modelence/src/auth/client/index.ts#L80)
