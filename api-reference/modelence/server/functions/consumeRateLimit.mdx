...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/322db0364daddfe864fcc9a9bb579edb272bf1b3/packages/modelence/src/rate-limit/rules.ts#L30)
