...
Defined in: [src/config/types.ts:17](https://github.com/modelence/modelence/blob/da8a100236747cbb5f621659811bb90f0af239d7/packages/modelence/src/config/types.ts#L17)
