...
Defined in: [src/config/server.ts:13](https://github.com/modelence/modelence/blob/0b6a6bfbe8060e61c18c99827e9c6d3ed4ea2590/packages/modelence/src/config/server.ts#L13)
