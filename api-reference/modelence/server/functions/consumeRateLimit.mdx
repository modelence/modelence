...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/d1d52b6f969e933e529c1339eec5ffb7b3601df3/packages/modelence/src/rate-limit/rules.ts#L30)
