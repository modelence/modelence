...
Defined in: [index.ts:34](https://github.com/modelence/modelence/blob/d30ed598c2e55606289379715fe783003cafb19f/packages/react-query/src/index.ts#L34)
...
| ------ | ------ | ------ |
| `queryFn()` | () => `Promise`\<`T`\> | [index.ts:40](https://github.com/modelence/modelence/blob/d30ed598c2e55606289379715fe783003cafb19f/packages/react-query/src/index.ts#L40) |
| `queryKey` | (`string` \| `Args`)[] | [index.ts:39](https://github.com/modelence/modelence/blob/d30ed598c2e55606289379715fe783003cafb19f/packages/react-query/src/index.ts#L39) |
