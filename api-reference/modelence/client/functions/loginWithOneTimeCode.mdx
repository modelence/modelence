...
Defined in: [packages/modelence/src/auth/client/index.ts:260](https://github.com/modelence/modelence/blob/8ed0afd3ef3e3a88722edb0201034f972e87fdef/packages/modelence/src/auth/client/index.ts#L260)
