...
Defined in: [src/rate-limit/rules.ts:29](https://github.com/modelence/modelence/blob/512ee88fe572f77aea1b2e49a9ab94a9ef5e3c14/packages/modelence/src/rate-limit/rules.ts#L29)
