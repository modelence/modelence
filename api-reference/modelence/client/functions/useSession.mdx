...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/809424c6b59ab40946028f4877726a845a1d5a48/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/809424c6b59ab40946028f4877726a845a1d5a48/packages/modelence/src/client/session.ts#L72) |
