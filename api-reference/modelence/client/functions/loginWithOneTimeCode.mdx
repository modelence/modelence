...
Defined in: [packages/modelence/src/auth/client/index.ts:235](https://github.com/modelence/modelence/blob/cc0f4538b7ae0d7a398a005ce0ab9792a385c9e1/packages/modelence/src/auth/client/index.ts#L235)
