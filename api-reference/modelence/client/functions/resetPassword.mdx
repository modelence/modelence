...
Defined in: [packages/modelence/src/auth/client/index.ts:182](https://github.com/modelence/modelence/blob/680d64084fed7a15f70256cec75827002d6dc4d5/packages/modelence/src/auth/client/index.ts#L182)
