...
Defined in: [src/config/server.ts:43](https://github.com/modelence/modelence/blob/cad865400af638ade463650c3a85246d284df73f/packages/modelence/src/config/server.ts#L43)
