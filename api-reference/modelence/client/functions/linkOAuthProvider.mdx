...
Defined in: [packages/modelence/src/auth/client/index.ts:184](https://github.com/modelence/modelence/blob/322db0364daddfe864fcc9a9bb579edb272bf1b3/packages/modelence/src/auth/client/index.ts#L184)
