...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/1e944710d976ab6b4f27315125c56e7e2853136b/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/1e944710d976ab6b4f27315125c56e7e2853136b/packages/modelence/src/client/session.ts#L72) |
