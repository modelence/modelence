...
Defined in: [packages/modelence/src/auth/db.ts:18](https://github.com/modelence/modelence/blob/2f6772c8bed12eee08443703fe95ae7980f94d0f/packages/modelence/src/auth/db.ts#L18)
