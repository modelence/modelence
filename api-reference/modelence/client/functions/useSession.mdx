...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/6663125b900e7f882bd1059aea6a268e42244b3a/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/6663125b900e7f882bd1059aea6a268e42244b3a/packages/modelence/src/client/session.ts#L72) |
