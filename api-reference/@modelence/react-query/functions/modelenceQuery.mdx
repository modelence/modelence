...
Defined in: [index.ts:108](https://github.com/modelence/modelence/blob/d16e98d4c4a8d602b897693839f48b5377a4a6a6/packages/react-query/src/index.ts#L108)
...
| ------ | ------ | ------ |
| `queryFn()` | () => `Promise`\<`T`\> | [index.ts:114](https://github.com/modelence/modelence/blob/d16e98d4c4a8d602b897693839f48b5377a4a6a6/packages/react-query/src/index.ts#L114) |
| `queryKey` | (`string` \| `Args`)[] | [index.ts:113](https://github.com/modelence/modelence/blob/d16e98d4c4a8d602b897693839f48b5377a4a6a6/packages/react-query/src/index.ts#L113) |
