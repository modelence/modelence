...
Defined in: [src/config/server.ts:43](https://github.com/modelence/modelence/blob/4f8fb2058a6b3450815bf31145b2e2f54511a295/packages/modelence/src/config/server.ts#L43)
