...
Defined in: [index.ts:34](https://github.com/modelence/modelence/blob/7e5aaad36b6290854f32f400608c1fe022c3eb0b/packages/react-query/src/index.ts#L34)
...
| ------ | ------ | ------ |
| `queryFn()` | () => `Promise`\<`T`\> | [index.ts:40](https://github.com/modelence/modelence/blob/7e5aaad36b6290854f32f400608c1fe022c3eb0b/packages/react-query/src/index.ts#L40) |
| `queryKey` | (`string` \| `Args`)[] | [index.ts:39](https://github.com/modelence/modelence/blob/7e5aaad36b6290854f32f400608c1fe022c3eb0b/packages/react-query/src/index.ts#L39) |
