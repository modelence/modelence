...
Defined in: [src/auth/client/index.ts:80](https://github.com/modelence/modelence/blob/7a30ecd22bee851ae2925fe6ba92db76a4d9e1d2/packages/modelence/src/auth/client/index.ts#L80)
