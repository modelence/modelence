...
Defined in: [packages/modelence/src/config/types.ts:81](https://github.com/modelence/modelence/blob/973cc89ef2746e47a7c3848264f67078ff1fbbcb/packages/modelence/src/config/types.ts#L81)
