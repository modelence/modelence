...
Defined in: [packages/modelence/src/files/index.ts:14](https://github.com/modelence/modelence/blob/1b85b1ec127ced8db69dbeddea16e7b7708f78b2/packages/modelence/src/files/index.ts#L14)
