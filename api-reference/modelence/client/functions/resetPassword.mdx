...
Defined in: [packages/modelence/src/auth/client/index.ts:279](https://github.com/modelence/modelence/blob/eda06f50bd0874b70a890c5bbc276abc6ab7fa5b/packages/modelence/src/auth/client/index.ts#L279)
