...
Defined in: [src/client/session.ts:94](https://github.com/modelence/modelence/blob/5a43bca087f9c3d4223f83f5e962ea79c59da20b/packages/modelence/src/client/session.ts#L94)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:96](https://github.com/modelence/modelence/blob/5a43bca087f9c3d4223f83f5e962ea79c59da20b/packages/modelence/src/client/session.ts#L96) |
