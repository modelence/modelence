...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/30fe36d2cf64cf9585e2112a17244e5591e12208/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/30fe36d2cf64cf9585e2112a17244e5591e12208/packages/modelence/src/client/session.ts#L72) |
