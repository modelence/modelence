...
Defined in: [src/config/types.ts:17](https://github.com/modelence/modelence/blob/695283456ab3c7d27a234a575033101333191efa/packages/modelence/src/config/types.ts#L17)
