...
Defined in: [src/config/client.ts:11](https://github.com/modelence/modelence/blob/be6625fed969d0fd35f96115e665d250bf95f3d2/packages/modelence/src/config/client.ts#L11)
