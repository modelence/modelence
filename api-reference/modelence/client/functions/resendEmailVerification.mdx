...
Defined in: [packages/modelence/src/auth/client/index.ts:135](https://github.com/modelence/modelence/blob/9ea445b4c52492ee3ebd2bf9add4c2077f93fed5/packages/modelence/src/auth/client/index.ts#L135)
