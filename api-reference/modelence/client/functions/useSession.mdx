...
Defined in: [src/client/session.ts:94](https://github.com/modelence/modelence/blob/b76bfde8ca036f6681de1ab2886a5a8ccf43aff5/packages/modelence/src/client/session.ts#L94)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:96](https://github.com/modelence/modelence/blob/b76bfde8ca036f6681de1ab2886a5a8ccf43aff5/packages/modelence/src/client/session.ts#L96) |
