...
Defined in: [src/config/server.ts:13](https://github.com/modelence/modelence/blob/285b6458bdff3aa05fa533e5422b0b751b9679c3/packages/modelence/src/config/server.ts#L13)
