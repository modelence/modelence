...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/f8a9d59bda40d01f9fc69d4a1531432c373416ae/packages/modelence/src/rate-limit/rules.ts#L30)
