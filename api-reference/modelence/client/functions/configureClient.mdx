...
Defined in: [packages/modelence/src/client/clientConfig.ts:66](https://github.com/modelence/modelence/blob/c9dcbfcaa25fc6772da51c4f8cb6a4557a221a12/packages/modelence/src/client/clientConfig.ts#L66)
