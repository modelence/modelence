...
Defined in: [packages/modelence/src/auth/db.ts:18](https://github.com/modelence/modelence/blob/e16b429698e5ea02170ccfabe4d8763ed52a9e3e/packages/modelence/src/auth/db.ts#L18)
