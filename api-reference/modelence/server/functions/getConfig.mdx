...
Defined in: [src/config/server.ts:13](https://github.com/modelence/modelence/blob/962b08ce69ad22f892abf58050eed45cb3cc4a18/packages/modelence/src/config/server.ts#L13)
