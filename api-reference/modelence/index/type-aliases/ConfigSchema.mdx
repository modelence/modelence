...
Defined in: [src/config/types.ts:17](https://github.com/modelence/modelence/blob/74a0b23212372269e92d9008022b1336b6340859/packages/modelence/src/config/types.ts#L17)
