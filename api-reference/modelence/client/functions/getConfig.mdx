...
Defined in: [packages/modelence/src/config/client.ts:11](https://github.com/modelence/modelence/blob/322db0364daddfe864fcc9a9bb579edb272bf1b3/packages/modelence/src/config/client.ts#L11)
