...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/9d4da98ed186cef49c1537617898d761a434daf6/packages/modelence/src/rate-limit/rules.ts#L30)
