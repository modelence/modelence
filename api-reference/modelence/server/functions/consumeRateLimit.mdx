...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/0f3135d1fd246498b6b63bc62de38b338702db08/packages/modelence/src/rate-limit/rules.ts#L30)
