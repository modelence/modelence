...
Defined in: [src/config/types.ts:17](https://github.com/modelence/modelence/blob/9127e3be695ee024b8107f7d048f3717671de429/packages/modelence/src/config/types.ts#L17)
