...
Defined in: [packages/modelence/src/auth/db.ts:18](https://github.com/modelence/modelence/blob/db9c28c1aff87e4e7487a6cbac8dcc5eec16a495/packages/modelence/src/auth/db.ts#L18)
