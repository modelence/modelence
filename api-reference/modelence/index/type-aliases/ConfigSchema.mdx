...
Defined in: [src/config/types.ts:17](https://github.com/modelence/modelence/blob/58d9840d767e7a8a0d115fc2e0a7f7e6118771e6/packages/modelence/src/config/types.ts#L17)
