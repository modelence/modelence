...
Defined in: [src/config/types.ts:17](https://github.com/modelence/modelence/blob/9320256ed22deab75d8a641bf705b49052de82c8/packages/modelence/src/config/types.ts#L17)
