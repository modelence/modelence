...
Defined in: [src/rate-limit/rules.ts:29](https://github.com/modelence/modelence/blob/92e8ef3b8e17265b22cb987ecf6083303a9d1782/packages/modelence/src/rate-limit/rules.ts#L29)
