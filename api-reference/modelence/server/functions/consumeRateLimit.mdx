...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/40773eea2e8cf4ad9c188b83e9b202852e2dda98/packages/modelence/src/rate-limit/rules.ts#L30)
