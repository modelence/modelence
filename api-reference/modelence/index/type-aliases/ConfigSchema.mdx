...
Defined in: [src/config/types.ts:17](https://github.com/modelence/modelence/blob/058768fe0d4b5ec6a83211d4f894db3f17565b0b/packages/modelence/src/config/types.ts#L17)
