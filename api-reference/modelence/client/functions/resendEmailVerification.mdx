...
Defined in: [packages/modelence/src/auth/client/index.ts:80](https://github.com/modelence/modelence/blob/2f6772c8bed12eee08443703fe95ae7980f94d0f/packages/modelence/src/auth/client/index.ts#L80)
