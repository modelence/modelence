...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/925045300d2a1859fb70eba87f5768745fb740fc/packages/modelence/src/rate-limit/rules.ts#L30)
