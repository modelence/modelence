...
Defined in: [packages/modelence/src/config/types.ts:81](https://github.com/modelence/modelence/blob/1fc500c6d43338c8655f6149ac557797fa7cc473/packages/modelence/src/config/types.ts#L81)
