...
[API Reference](/sdk/@modelence/react-query/functions/../../../index) / [@modelence/react-query](/sdk/@modelence/react-query/functions/../index) / modelenceMutation

> **modelenceMutation**\<`T`\>(`methodName`, `defaultArgs`): `object`

Defined in: [index.ts:242](https://github.com/modelence/modelence/blob/2bab721ac88d96d5e8ecc0fab7d291f1c1a2be96/packages/react-query/src/index.ts#L242)
...
| ------ | ------ | ------ |
| `mutationFn()` | (`variables`) => `Promise`\<`T`\> | [index.ts:247](https://github.com/modelence/modelence/blob/2bab721ac88d96d5e8ecc0fab7d291f1c1a2be96/packages/react-query/src/index.ts#L247) |
