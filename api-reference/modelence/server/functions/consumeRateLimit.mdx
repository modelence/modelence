...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/03f21b540e2b4cecd6efb35269dbc6dd9b6a7b72/packages/modelence/src/rate-limit/rules.ts#L30)
