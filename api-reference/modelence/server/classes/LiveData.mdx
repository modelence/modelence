...
| ------ | ------ | ------ | ------ |
| <a id="fetch"></a> `fetch` | `readonly` | () => `T` \| `Promise`\<`T`\> | [packages/modelence/src/live-query/context.ts:66](https://github.com/modelence/modelence/blob/f614ecc6811cdda9670d612872c8ff49a49c5e28/packages/modelence/src/live-query/context.ts#L66) |
| <a id="watch"></a> `watch` | `readonly` | [`LiveQueryWatch`](/api-reference/modelence/server/classes/../type-aliases/LiveQueryWatch) | [packages/modelence/src/live-query/context.ts:67](https://github.com/modelence/modelence/blob/f614ecc6811cdda9670d612872c8ff49a49c5e28/packages/modelence/src/live-query/context.ts#L67) |
