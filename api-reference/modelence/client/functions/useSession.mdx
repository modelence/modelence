...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/21300850024534c8cf6d8f0eeb2ddb6fe60dad37/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/21300850024534c8cf6d8f0eeb2ddb6fe60dad37/packages/modelence/src/client/session.ts#L72) |
