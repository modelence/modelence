...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/26581c9df651cf1af4e4393e03139fce94fe6d80/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/26581c9df651cf1af4e4393e03139fce94fe6d80/packages/modelence/src/client/session.ts#L72) |
