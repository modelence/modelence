...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/794a3f95b63a9facc0caf4230808b49852778da0/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/794a3f95b63a9facc0caf4230808b49852778da0/packages/modelence/src/client/session.ts#L72) |
