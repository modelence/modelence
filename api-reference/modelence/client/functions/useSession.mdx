...
Defined in: [src/client/session.ts:94](https://github.com/modelence/modelence/blob/07be4eb0140a3cfe4c9f1ba12b97b45d1c4600f0/packages/modelence/src/client/session.ts#L94)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:96](https://github.com/modelence/modelence/blob/07be4eb0140a3cfe4c9f1ba12b97b45d1c4600f0/packages/modelence/src/client/session.ts#L96) |
