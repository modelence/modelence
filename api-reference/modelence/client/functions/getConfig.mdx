...
Defined in: [src/config/client.ts:11](https://github.com/modelence/modelence/blob/9bdd4639a073cbfb1ef129b1959fa61871fa580c/packages/modelence/src/config/client.ts#L11)
