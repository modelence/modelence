...
Defined in: [packages/modelence/src/auth/db.ts:18](https://github.com/modelence/modelence/blob/6aa8727b2ecb9395a4c102be7e51d38394b2c23f/packages/modelence/src/auth/db.ts#L18)
