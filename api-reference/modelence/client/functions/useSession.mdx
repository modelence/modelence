...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/74a0b23212372269e92d9008022b1336b6340859/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/74a0b23212372269e92d9008022b1336b6340859/packages/modelence/src/client/session.ts#L72) |
