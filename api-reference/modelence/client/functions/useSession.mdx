...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/77b2ece9e470bd518ec28a2f7c1346f10452ec29/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/77b2ece9e470bd518ec28a2f7c1346f10452ec29/packages/modelence/src/client/session.ts#L72) |
