...
Defined in: [packages/modelence/src/rate-limit/rules.ts:29](https://github.com/modelence/modelence/blob/353901b6d85963c47d2ef4dd38e3fc4eaa3b0e39/packages/modelence/src/rate-limit/rules.ts#L29)
