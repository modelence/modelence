...
Defined in: [packages/modelence/src/config/types.ts:81](https://github.com/modelence/modelence/blob/31e031bcb9dcae41497121e2197a497c59cf9f5b/packages/modelence/src/config/types.ts#L81)
