...
Defined in: [packages/modelence/src/config/server.ts:43](https://github.com/modelence/modelence/blob/eff60a49c5827e5240a61cdee9ad715a06ff3c04/packages/modelence/src/config/server.ts#L43)
