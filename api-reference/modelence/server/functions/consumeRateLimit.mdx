...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/f0a3ac1e88d120f9978f21e0fe2bf5fb7f60db51/packages/modelence/src/rate-limit/rules.ts#L30)
