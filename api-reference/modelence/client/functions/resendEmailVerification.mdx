...
Defined in: [packages/modelence/src/auth/client/index.ts:135](https://github.com/modelence/modelence/blob/1b85b1ec127ced8db69dbeddea16e7b7708f78b2/packages/modelence/src/auth/client/index.ts#L135)
