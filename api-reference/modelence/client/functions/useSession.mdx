...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/0e0fb90bc587cbdcb5a646a5ad3721c781344656/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/0e0fb90bc587cbdcb5a646a5ad3721c781344656/packages/modelence/src/client/session.ts#L72) |
