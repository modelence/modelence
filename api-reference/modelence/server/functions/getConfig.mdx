...
Defined in: [src/config/server.ts:43](https://github.com/modelence/modelence/blob/dca9b607dbb1ba0ed6f2510846506b1a667d1b35/packages/modelence/src/config/server.ts#L43)
