...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/05ac1b747aa6f2d488192772f7b7b9435623732b/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/05ac1b747aa6f2d488192772f7b7b9435623732b/packages/modelence/src/client/session.ts#L72) |
