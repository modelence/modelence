...
Defined in: [src/config/types.ts:17](https://github.com/modelence/modelence/blob/b76bfde8ca036f6681de1ab2886a5a8ccf43aff5/packages/modelence/src/config/types.ts#L17)
