...
Defined in: [src/config/server.ts:13](https://github.com/modelence/modelence/blob/6663125b900e7f882bd1059aea6a268e42244b3a/packages/modelence/src/config/server.ts#L13)
