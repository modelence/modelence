...
Defined in: [packages/modelence/src/auth/client/index.ts:43](https://github.com/modelence/modelence/blob/f88b8e36b7462350566e0fb104dcb2beb7d8bbdb/packages/modelence/src/auth/client/index.ts#L43)
