...
Defined in: [src/config/server.ts:13](https://github.com/modelence/modelence/blob/794a3f95b63a9facc0caf4230808b49852778da0/packages/modelence/src/config/server.ts#L13)
