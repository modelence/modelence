...
Defined in: [index.ts:75](https://github.com/modelence/modelence/blob/be6625fed969d0fd35f96115e665d250bf95f3d2/packages/react-query/src/index.ts#L75)
...
| ------ | ------ | ------ |
| `mutationFn()` | (`variables`) => `Promise`\<`T`\> | [index.ts:80](https://github.com/modelence/modelence/blob/be6625fed969d0fd35f96115e665d250bf95f3d2/packages/react-query/src/index.ts#L80) |
