...
Defined in: [packages/modelence/src/rate-limit/rules.ts:29](https://github.com/modelence/modelence/blob/122f0a1824ca045e1f4108decea9d09bee89cb3a/packages/modelence/src/rate-limit/rules.ts#L29)
