...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/2f6772c8bed12eee08443703fe95ae7980f94d0f/packages/modelence/src/rate-limit/rules.ts#L30)
