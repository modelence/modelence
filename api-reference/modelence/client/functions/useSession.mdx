...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/7e5aaad36b6290854f32f400608c1fe022c3eb0b/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/7e5aaad36b6290854f32f400608c1fe022c3eb0b/packages/modelence/src/client/session.ts#L72) |
