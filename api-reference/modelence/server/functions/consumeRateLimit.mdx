...
Defined in: [packages/modelence/src/rate-limit/rules.ts:29](https://github.com/modelence/modelence/blob/ec98acdba4fa0b3ce76989cbaf47276e2d2556fd/packages/modelence/src/rate-limit/rules.ts#L29)
