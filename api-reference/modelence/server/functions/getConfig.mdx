...
Defined in: [src/config/server.ts:46](https://github.com/modelence/modelence/blob/a98c06449c1342b806775f739bd458d3c703b83e/packages/modelence/src/config/server.ts#L46)
