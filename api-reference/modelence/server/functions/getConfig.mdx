...
Defined in: [src/config/server.ts:43](https://github.com/modelence/modelence/blob/90c266574333430bd7e5eb1b19555ddac1006208/packages/modelence/src/config/server.ts#L43)
