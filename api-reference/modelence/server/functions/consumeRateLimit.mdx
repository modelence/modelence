...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/95097a0b2f0cfaa7c23437950aa39529f09ed4ff/packages/modelence/src/rate-limit/rules.ts#L30)
