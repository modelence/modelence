...
Defined in: [packages/modelence/src/config/types.ts:81](https://github.com/modelence/modelence/blob/9d4da98ed186cef49c1537617898d761a434daf6/packages/modelence/src/config/types.ts#L81)
