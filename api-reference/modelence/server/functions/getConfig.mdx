...
Defined in: [src/config/server.ts:43](https://github.com/modelence/modelence/blob/55fa59c7537464f4bb0709986cc83c584efe837f/packages/modelence/src/config/server.ts#L43)
