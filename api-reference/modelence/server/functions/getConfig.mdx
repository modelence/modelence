...
Defined in: [src/config/server.ts:13](https://github.com/modelence/modelence/blob/695283456ab3c7d27a234a575033101333191efa/packages/modelence/src/config/server.ts#L13)
