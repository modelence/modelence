...
Defined in: [src/config/server.ts:46](https://github.com/modelence/modelence/blob/0b6733f929d9a9924993eb740aa6cd4a165aa17c/packages/modelence/src/config/server.ts#L46)
