...
Defined in: [src/config/server.ts:43](https://github.com/modelence/modelence/blob/d030f1c856ac4c3cd58411a3d83210079cf1c745/packages/modelence/src/config/server.ts#L43)
