...
Defined in: [src/config/server.ts:13](https://github.com/modelence/modelence/blob/9127e3be695ee024b8107f7d048f3717671de429/packages/modelence/src/config/server.ts#L13)
