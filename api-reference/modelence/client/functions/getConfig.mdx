...
Defined in: [packages/modelence/src/config/client.ts:11](https://github.com/modelence/modelence/blob/4f5f1f9eadbc965a251fab8fdd084b1445036039/packages/modelence/src/config/client.ts#L11)
