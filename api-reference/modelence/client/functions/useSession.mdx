...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/532bd9d6d1803acfaae9221933b66252aeb7e028/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/532bd9d6d1803acfaae9221933b66252aeb7e028/packages/modelence/src/client/session.ts#L72) |
