...
Defined in: [index.ts:34](https://github.com/modelence/modelence/blob/7663926177663a9b76e0970308093747584c5d21/packages/react-query/src/index.ts#L34)
...
| ------ | ------ | ------ |
| `queryFn()` | () => `Promise`\<`T`\> | [index.ts:40](https://github.com/modelence/modelence/blob/7663926177663a9b76e0970308093747584c5d21/packages/react-query/src/index.ts#L40) |
| `queryKey` | (`string` \| `Args`)[] | [index.ts:39](https://github.com/modelence/modelence/blob/7663926177663a9b76e0970308093747584c5d21/packages/react-query/src/index.ts#L39) |
