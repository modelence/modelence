...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/8ec5ac75b7906ad5b8cc27c550f3014b8fe6f913/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/8ec5ac75b7906ad5b8cc27c550f3014b8fe6f913/packages/modelence/src/client/session.ts#L72) |
