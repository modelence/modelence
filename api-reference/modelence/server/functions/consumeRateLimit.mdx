...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/e36099f685519917f922476b2df2ed20991c7d0f/packages/modelence/src/rate-limit/rules.ts#L30)
