...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/896d810f6262c8a1c46359c38bd8aee36ea48a4d/packages/modelence/src/rate-limit/rules.ts#L30)
