...
Defined in: [src/client/session.ts:94](https://github.com/modelence/modelence/blob/45cb8dfe664fced4d28b5cd14a6f6149dc361f3b/packages/modelence/src/client/session.ts#L94)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:96](https://github.com/modelence/modelence/blob/45cb8dfe664fced4d28b5cd14a6f6149dc361f3b/packages/modelence/src/client/session.ts#L96) |
