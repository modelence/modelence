...
Defined in: [packages/modelence/src/auth/client/index.ts:135](https://github.com/modelence/modelence/blob/8eaee914a65e822e1ea0ebbc8f7d2835786551db/packages/modelence/src/auth/client/index.ts#L135)
