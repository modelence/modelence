...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/f40d9063897ff569e8c8658fc409857fcee845f2/packages/modelence/src/rate-limit/rules.ts#L30)
