...
Defined in: [packages/modelence/src/auth/client/index.ts:135](https://github.com/modelence/modelence/blob/a89326e2c7b8f250ed9e03dd1024ca051acd35dd/packages/modelence/src/auth/client/index.ts#L135)
