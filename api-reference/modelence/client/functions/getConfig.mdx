...
Defined in: [packages/modelence/src/config/client.ts:19](https://github.com/modelence/modelence/blob/3ece382ff59fb0f623ba01aaed723a2487aecc51/packages/modelence/src/config/client.ts#L19)
