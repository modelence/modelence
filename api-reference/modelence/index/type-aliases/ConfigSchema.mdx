...
Defined in: [packages/modelence/src/config/types.ts:81](https://github.com/modelence/modelence/blob/4440162e3c5ddffed08300cbb3bc8eff4a9566f6/packages/modelence/src/config/types.ts#L81)
