...
Defined in: [packages/modelence/src/auth/client/index.ts:197](https://github.com/modelence/modelence/blob/24ed11776f0d157e559834c800a9333d0af28f69/packages/modelence/src/auth/client/index.ts#L197)
