...
Defined in: [packages/modelence/src/auth/client/index.ts:143](https://github.com/modelence/modelence/blob/1b3a7e0b812638505384ede91194263778670ee8/packages/modelence/src/auth/client/index.ts#L143)
