...
Defined in: [packages/modelence/src/auth/client/index.ts:80](https://github.com/modelence/modelence/blob/92ab275a6df8ec055091fc4e374a06348f2cc99b/packages/modelence/src/auth/client/index.ts#L80)
