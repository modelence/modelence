...
Defined in: [index.ts:108](https://github.com/modelence/modelence/blob/a7d1ab8431181b95ae21f698af9c96598f725c25/packages/react-query/src/index.ts#L108)
...
| ------ | ------ | ------ |
| `queryFn()` | () => `Promise`\<`T`\> | [index.ts:114](https://github.com/modelence/modelence/blob/a7d1ab8431181b95ae21f698af9c96598f725c25/packages/react-query/src/index.ts#L114) |
| `queryKey` | (`string` \| `Args`)[] | [index.ts:113](https://github.com/modelence/modelence/blob/a7d1ab8431181b95ae21f698af9c96598f725c25/packages/react-query/src/index.ts#L113) |
