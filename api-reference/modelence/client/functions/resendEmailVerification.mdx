...
Defined in: [packages/modelence/src/auth/client/index.ts:80](https://github.com/modelence/modelence/blob/2cc83b7b0a080c239695bc86ed2cba4df5308681/packages/modelence/src/auth/client/index.ts#L80)
