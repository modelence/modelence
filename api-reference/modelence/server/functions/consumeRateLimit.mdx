...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/b0e3e423ec76c281286ba532e519e0a837020df2/packages/modelence/src/rate-limit/rules.ts#L30)
