...
Defined in: [packages/modelence/src/config/server.ts:43](https://github.com/modelence/modelence/blob/4440162e3c5ddffed08300cbb3bc8eff4a9566f6/packages/modelence/src/config/server.ts#L43)
