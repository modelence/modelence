...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/a530a6bfa0810a61d6e0f6f5fe9d9c88bee575e4/packages/modelence/src/rate-limit/rules.ts#L30)
