...
Defined in: [index.ts:75](https://github.com/modelence/modelence/blob/d4cddd720cd27afa0b3acc864c0d8ac010ed448c/packages/react-query/src/index.ts#L75)
...
| ------ | ------ | ------ |
| `mutationFn()` | (`variables`) => `Promise`\<`T`\> | [index.ts:80](https://github.com/modelence/modelence/blob/d4cddd720cd27afa0b3acc864c0d8ac010ed448c/packages/react-query/src/index.ts#L80) |
