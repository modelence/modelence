...
Defined in: [src/auth/client/index.ts:37](https://github.com/modelence/modelence/blob/d4cddd720cd27afa0b3acc864c0d8ac010ed448c/packages/modelence/src/auth/client/index.ts#L37)
