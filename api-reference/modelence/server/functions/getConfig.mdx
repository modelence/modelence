...
Defined in: [src/config/server.ts:13](https://github.com/modelence/modelence/blob/df0c5788435c8faa0f8712932d26a40268a9218f/packages/modelence/src/config/server.ts#L13)
