...
Defined in: [src/config/types.ts:17](https://github.com/modelence/modelence/blob/7663926177663a9b76e0970308093747584c5d21/packages/modelence/src/config/types.ts#L17)
