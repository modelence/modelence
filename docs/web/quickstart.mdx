...
<Steps>
  ...
  <Step title="Create an app">
    Click **Create App**, then describe what you want to build in the prompt field. For example:
  ...
  <Step title="Share or deploy">
    Your app is automatically deployed to a live URL on Modelence Cloud. You can share it immediately or connect a custom domain.
  </Step>
</Steps>
