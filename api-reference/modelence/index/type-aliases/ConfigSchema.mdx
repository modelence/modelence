...
Defined in: [packages/modelence/src/config/types.ts:81](https://github.com/modelence/modelence/blob/cc0f4538b7ae0d7a398a005ce0ab9792a385c9e1/packages/modelence/src/config/types.ts#L81)
