...
Defined in: [src/config/client.ts:11](https://github.com/modelence/modelence/blob/039beeaa0fd96ae23fb8ca84a7f8e5b25b9d826d/packages/modelence/src/config/client.ts#L11)
