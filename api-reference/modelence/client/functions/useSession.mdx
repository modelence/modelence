...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/285b6458bdff3aa05fa533e5422b0b751b9679c3/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/285b6458bdff3aa05fa533e5422b0b751b9679c3/packages/modelence/src/client/session.ts#L72) |
