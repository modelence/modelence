...
5. **Add your Voyage AI API key**:
   ...
   - In the Modelence Cloud dashboard, open your environment's Settings page and add `MODELENCE_VOYAGEAI_API_KEY` as an environment variable with your API key as the value
