...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/058768fe0d4b5ec6a83211d4f894db3f17565b0b/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/058768fe0d4b5ec6a83211d4f894db3f17565b0b/packages/modelence/src/client/session.ts#L72) |
