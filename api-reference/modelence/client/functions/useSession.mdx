...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/eb0758916af0194c0b9b05aed928d49828c2de43/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/eb0758916af0194c0b9b05aed928d49828c2de43/packages/modelence/src/client/session.ts#L72) |
