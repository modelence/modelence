...
Defined in: [packages/modelence/src/auth/db.ts:18](https://github.com/modelence/modelence/blob/1e9ff395f60f475313a797050277f80af6a46693/packages/modelence/src/auth/db.ts#L18)
