...
app and the IDE extensions bundle their own private copy, so if `claude` isn't found, install the CLI
from [code.claude.com](https://code.claude.com/docs/en/setup) first.
</Note>
