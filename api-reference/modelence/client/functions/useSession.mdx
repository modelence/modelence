...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/62259b6697571b616c549c71583a3c319522198d/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/62259b6697571b616c549c71583a3c319522198d/packages/modelence/src/client/session.ts#L72) |
