...
Defined in: [src/config/server.ts:43](https://github.com/modelence/modelence/blob/9320256ed22deab75d8a641bf705b49052de82c8/packages/modelence/src/config/server.ts#L43)
