...
Defined in: [src/config/server.ts:13](https://github.com/modelence/modelence/blob/97bc424e385e6893aeebb42dc6a72bd4812fd999/packages/modelence/src/config/server.ts#L13)
