...
Defined in: [packages/modelence/src/config/client.ts:19](https://github.com/modelence/modelence/blob/8ed0afd3ef3e3a88722edb0201034f972e87fdef/packages/modelence/src/config/client.ts#L19)
