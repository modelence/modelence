...
Defined in: [packages/modelence/src/auth/client/index.ts:216](https://github.com/modelence/modelence/blob/06ef6e9500878fe6d1e5dc5484935418772f777c/packages/modelence/src/auth/client/index.ts#L216)
