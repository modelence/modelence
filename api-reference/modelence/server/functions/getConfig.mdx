...
Defined in: [src/config/server.ts:43](https://github.com/modelence/modelence/blob/325c91aebd194a53a7ce74c7cc6f91fa9905b878/packages/modelence/src/config/server.ts#L43)
