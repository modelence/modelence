...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/a0169301d3e95b3e412e0030d93641ad386443db/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/a0169301d3e95b3e412e0030d93641ad386443db/packages/modelence/src/client/session.ts#L72) |
