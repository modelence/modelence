...
Defined in: [packages/modelence/src/config/server.ts:43](https://github.com/modelence/modelence/blob/0f25b330a29a2250b69a98eb92dcc50cdd4694e9/packages/modelence/src/config/server.ts#L43)
