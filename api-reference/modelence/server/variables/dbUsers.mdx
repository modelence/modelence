...
Defined in: [packages/modelence/src/auth/db.ts:18](https://github.com/modelence/modelence/blob/03ec2d5cc1a12f31d06b58cdbc1c1802eb53f556/packages/modelence/src/auth/db.ts#L18)
