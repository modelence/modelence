...
- Learn about [Authentication](/authentication) to add user management
- Explore [Email](/email) configuration for transactional emails
- Review [WebSockets](/websockets) for real-time features
