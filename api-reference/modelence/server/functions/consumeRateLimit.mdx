...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/e16b429698e5ea02170ccfabe4d8763ed52a9e3e/packages/modelence/src/rate-limit/rules.ts#L30)
