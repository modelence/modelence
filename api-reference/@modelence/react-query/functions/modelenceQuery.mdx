...
Defined in: [index.ts:108](https://github.com/modelence/modelence/blob/1b3a7e0b812638505384ede91194263778670ee8/packages/react-query/src/index.ts#L108)
...
| ------ | ------ | ------ |
| `queryFn()` | () => `Promise`\<`T`\> | [index.ts:114](https://github.com/modelence/modelence/blob/1b3a7e0b812638505384ede91194263778670ee8/packages/react-query/src/index.ts#L114) |
| `queryKey` | (`string` \| `Args`)[] | [index.ts:113](https://github.com/modelence/modelence/blob/1b3a7e0b812638505384ede91194263778670ee8/packages/react-query/src/index.ts#L113) |
