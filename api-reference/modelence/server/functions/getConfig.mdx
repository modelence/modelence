...
Defined in: [src/config/server.ts:13](https://github.com/modelence/modelence/blob/3d38d399776fc82b65c57ffd240ca33361f43e84/packages/modelence/src/config/server.ts#L13)
