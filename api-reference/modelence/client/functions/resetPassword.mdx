...
Defined in: [packages/modelence/src/auth/client/index.ts:182](https://github.com/modelence/modelence/blob/74589a5831526731280a6168830814a60b639296/packages/modelence/src/auth/client/index.ts#L182)
