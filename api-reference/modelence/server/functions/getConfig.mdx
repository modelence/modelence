...
Defined in: [src/config/server.ts:13](https://github.com/modelence/modelence/blob/3fae98d242d920a510c5611b305dbc4f770799d1/packages/modelence/src/config/server.ts#L13)
