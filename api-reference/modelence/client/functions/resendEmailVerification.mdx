...
Defined in: [packages/modelence/src/auth/client/index.ts:135](https://github.com/modelence/modelence/blob/161587a066fb21d77222dd04dcd85906356142d2/packages/modelence/src/auth/client/index.ts#L135)
