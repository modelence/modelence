...
Defined in: [src/config/client.ts:11](https://github.com/modelence/modelence/blob/532bd9d6d1803acfaae9221933b66252aeb7e028/packages/modelence/src/config/client.ts#L11)
