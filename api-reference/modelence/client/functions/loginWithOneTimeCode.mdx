...
Defined in: [packages/modelence/src/auth/client/index.ts:235](https://github.com/modelence/modelence/blob/1cba4febffc6e13a76a88a761cd2db3c4ec0da1e/packages/modelence/src/auth/client/index.ts#L235)
