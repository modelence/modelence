...
Defined in: [packages/modelence/src/config/client.ts:11](https://github.com/modelence/modelence/blob/161587a066fb21d77222dd04dcd85906356142d2/packages/modelence/src/config/client.ts#L11)
