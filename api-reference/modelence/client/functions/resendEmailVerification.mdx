...
Defined in: [packages/modelence/src/auth/client/index.ts:135](https://github.com/modelence/modelence/blob/51ac3e90a5125bd1125bed589b7d27f203f4eca0/packages/modelence/src/auth/client/index.ts#L135)
