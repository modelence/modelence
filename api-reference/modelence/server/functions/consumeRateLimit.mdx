...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/b4e57e365f5d5315014b4e0ac689bf4dbef2fa24/packages/modelence/src/rate-limit/rules.ts#L30)
