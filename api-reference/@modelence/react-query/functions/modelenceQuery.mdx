...
Defined in: [index.ts:108](https://github.com/modelence/modelence/blob/68301d7afc335332b01306a912b7cf9c390ea0b5/packages/react-query/src/index.ts#L108)
...
| ------ | ------ | ------ |
| `queryFn()` | () => `Promise`\<`T`\> | [index.ts:114](https://github.com/modelence/modelence/blob/68301d7afc335332b01306a912b7cf9c390ea0b5/packages/react-query/src/index.ts#L114) |
| `queryKey` | (`string` \| `Args`)[] | [index.ts:113](https://github.com/modelence/modelence/blob/68301d7afc335332b01306a912b7cf9c390ea0b5/packages/react-query/src/index.ts#L113) |
