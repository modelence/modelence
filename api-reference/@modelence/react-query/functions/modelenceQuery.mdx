...
Defined in: [index.ts:108](https://github.com/modelence/modelence/blob/458a34c72cf078264dccea8c85b21ffa16d37642/packages/react-query/src/index.ts#L108)
...
| ------ | ------ | ------ |
| `queryFn()` | () => `Promise`\<`T`\> | [index.ts:114](https://github.com/modelence/modelence/blob/458a34c72cf078264dccea8c85b21ffa16d37642/packages/react-query/src/index.ts#L114) |
| `queryKey` | (`string` \| `Args`)[] | [index.ts:113](https://github.com/modelence/modelence/blob/458a34c72cf078264dccea8c85b21ffa16d37642/packages/react-query/src/index.ts#L113) |
