...
Defined in: [packages/modelence/src/auth/client/index.ts:80](https://github.com/modelence/modelence/blob/a3176932dc4c6b6d1bde9acd92193dbd991998a9/packages/modelence/src/auth/client/index.ts#L80)
