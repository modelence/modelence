...
Defined in: [packages/modelence/src/config/types.ts:81](https://github.com/modelence/modelence/blob/925045300d2a1859fb70eba87f5768745fb740fc/packages/modelence/src/config/types.ts#L81)
