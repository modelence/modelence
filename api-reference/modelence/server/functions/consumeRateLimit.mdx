...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/a89326e2c7b8f250ed9e03dd1024ca051acd35dd/packages/modelence/src/rate-limit/rules.ts#L30)
