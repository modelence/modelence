...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/03ec2d5cc1a12f31d06b58cdbc1c1802eb53f556/packages/modelence/src/rate-limit/rules.ts#L30)
