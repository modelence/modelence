...
Defined in: [index.ts:108](https://github.com/modelence/modelence/blob/903b7aa83bb665e416b229aedeca2d12bb361df1/packages/react-query/src/index.ts#L108)
...
| ------ | ------ | ------ |
| `queryFn()` | () => `Promise`\<`T`\> | [index.ts:114](https://github.com/modelence/modelence/blob/903b7aa83bb665e416b229aedeca2d12bb361df1/packages/react-query/src/index.ts#L114) |
| `queryKey` | (`string` \| `Args`)[] | [index.ts:113](https://github.com/modelence/modelence/blob/903b7aa83bb665e416b229aedeca2d12bb361df1/packages/react-query/src/index.ts#L113) |
