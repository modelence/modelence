...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/d56381f6db1b4ecac75a356888e3592a5a3d64f7/packages/modelence/src/rate-limit/rules.ts#L30)
