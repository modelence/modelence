...
Defined in: [packages/modelence/src/auth/db.ts:18](https://github.com/modelence/modelence/blob/3ece382ff59fb0f623ba01aaed723a2487aecc51/packages/modelence/src/auth/db.ts#L18)
