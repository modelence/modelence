...
Defined in: [src/config/server.ts:13](https://github.com/modelence/modelence/blob/90c00c5f59ec5153021760e5dfd26d4c23d21fbd/packages/modelence/src/config/server.ts#L13)
