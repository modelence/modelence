...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/c6eb622fc7b8d1f12955379f26a1317deda6e151/packages/modelence/src/rate-limit/rules.ts#L30)
