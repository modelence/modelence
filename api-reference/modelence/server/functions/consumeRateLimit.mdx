...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/edf0ff8282b22c5aa226ea03584e6a4ce7ca489e/packages/modelence/src/rate-limit/rules.ts#L30)
