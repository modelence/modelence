...
Defined in: [packages/modelence/src/client/clientConfig.ts:66](https://github.com/modelence/modelence/blob/4440162e3c5ddffed08300cbb3bc8eff4a9566f6/packages/modelence/src/client/clientConfig.ts#L66)
