...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/3b87d65207e4ed7ebee0b08a19692450fec0975a/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/3b87d65207e4ed7ebee0b08a19692450fec0975a/packages/modelence/src/client/session.ts#L72) |
