...
Defined in: [packages/modelence/src/config/types.ts:81](https://github.com/modelence/modelence/blob/1673fdda7f456f608a341068176326d8dc163f3b/packages/modelence/src/config/types.ts#L81)
