...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/134efca3d9a9e8d8b0189b193e71f735cb08b5c0/packages/modelence/src/rate-limit/rules.ts#L30)
