...
Defined in: [packages/modelence/src/rate-limit/rules.ts:29](https://github.com/modelence/modelence/blob/4b5d4e42580d348e4979d6d48843d3b7edb2c8bf/packages/modelence/src/rate-limit/rules.ts#L29)
