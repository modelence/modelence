...
Defined in: [src/config/server.ts:43](https://github.com/modelence/modelence/blob/5516f71e3f09530b090c9eb2b258cbec87324c1e/packages/modelence/src/config/server.ts#L43)
