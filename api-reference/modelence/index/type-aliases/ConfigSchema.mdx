...
Defined in: [src/config/types.ts:17](https://github.com/modelence/modelence/blob/910a4187b3dcb47ecc312c0d2e536b4b2131670d/packages/modelence/src/config/types.ts#L17)
