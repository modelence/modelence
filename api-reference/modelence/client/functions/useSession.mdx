...
Defined in: [src/client/session.ts:94](https://github.com/modelence/modelence/blob/7a3f73267b8c31a9920c7e7fb161d8f3f1849997/packages/modelence/src/client/session.ts#L94)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:96](https://github.com/modelence/modelence/blob/7a3f73267b8c31a9920c7e7fb161d8f3f1849997/packages/modelence/src/client/session.ts#L96) |
