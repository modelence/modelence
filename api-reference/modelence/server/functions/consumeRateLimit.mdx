...
Defined in: [src/rate-limit/rules.ts:29](https://github.com/modelence/modelence/blob/dc62f47aa64feb1b8873717e14be742a0d20c990/packages/modelence/src/rate-limit/rules.ts#L29)
