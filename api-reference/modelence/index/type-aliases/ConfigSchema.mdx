...
Defined in: [packages/modelence/src/config/types.ts:81](https://github.com/modelence/modelence/blob/68301d7afc335332b01306a912b7cf9c390ea0b5/packages/modelence/src/config/types.ts#L81)
