...
Defined in: [src/config/server.ts:13](https://github.com/modelence/modelence/blob/a0169301d3e95b3e412e0030d93641ad386443db/packages/modelence/src/config/server.ts#L13)
