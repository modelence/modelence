...
Defined in: [packages/modelence/src/rate-limit/rules.ts:29](https://github.com/modelence/modelence/blob/127dec5c1271789acf62401693c25d8639abd335/packages/modelence/src/rate-limit/rules.ts#L29)
