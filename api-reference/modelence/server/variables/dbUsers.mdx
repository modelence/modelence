...
Defined in: [packages/modelence/src/auth/db.ts:18](https://github.com/modelence/modelence/blob/a33e01dffb7e1c39a5fedd0cd9b7ccf679248cfe/packages/modelence/src/auth/db.ts#L18)
