...
Defined in: [index.ts:108](https://github.com/modelence/modelence/blob/90c266574333430bd7e5eb1b19555ddac1006208/packages/react-query/src/index.ts#L108)
...
| ------ | ------ | ------ |
| `queryFn()` | () => `Promise`\<`T`\> | [index.ts:114](https://github.com/modelence/modelence/blob/90c266574333430bd7e5eb1b19555ddac1006208/packages/react-query/src/index.ts#L114) |
| `queryKey` | (`string` \| `Args`)[] | [index.ts:113](https://github.com/modelence/modelence/blob/90c266574333430bd7e5eb1b19555ddac1006208/packages/react-query/src/index.ts#L113) |
