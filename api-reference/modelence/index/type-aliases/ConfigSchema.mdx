...
Defined in: [src/config/types.ts:17](https://github.com/modelence/modelence/blob/3b87d65207e4ed7ebee0b08a19692450fec0975a/packages/modelence/src/config/types.ts#L17)
