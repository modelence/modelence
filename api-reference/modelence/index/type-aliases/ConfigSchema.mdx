...
Defined in: [src/config/types.ts:17](https://github.com/modelence/modelence/blob/3f1fd635e8381fab6218a1a4e54da43042986b70/packages/modelence/src/config/types.ts#L17)
