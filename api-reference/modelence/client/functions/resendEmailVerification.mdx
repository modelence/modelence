...
Defined in: [packages/modelence/src/auth/client/index.ts:80](https://github.com/modelence/modelence/blob/134efca3d9a9e8d8b0189b193e71f735cb08b5c0/packages/modelence/src/auth/client/index.ts#L80)
