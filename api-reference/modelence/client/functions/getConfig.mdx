...
Defined in: [src/config/client.ts:11](https://github.com/modelence/modelence/blob/90c266574333430bd7e5eb1b19555ddac1006208/packages/modelence/src/config/client.ts#L11)
