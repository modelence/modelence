...
Once you have your connection string, you'll need to add it to your Modelence environment variables. Create a `.env` file in your project root (if it doesn't exist already) and add:
...
<Warning>
Make sure that your `.env` file is added to your `.gitignore` to keep your credentials secure.
</Warning>
