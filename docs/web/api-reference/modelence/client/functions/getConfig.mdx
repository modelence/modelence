...
Defined in: [src/config/client.ts:11](https://github.com/modelence/modelence/blob/7663926177663a9b76e0970308093747584c5d21/packages/modelence/src/config/client.ts#L11)
