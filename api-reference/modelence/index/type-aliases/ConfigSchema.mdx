...
Defined in: [packages/modelence/src/config/types.ts:81](https://github.com/modelence/modelence/blob/4f5f1f9eadbc965a251fab8fdd084b1445036039/packages/modelence/src/config/types.ts#L81)
