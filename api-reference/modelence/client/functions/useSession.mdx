...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/90c00c5f59ec5153021760e5dfd26d4c23d21fbd/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/90c00c5f59ec5153021760e5dfd26d4c23d21fbd/packages/modelence/src/client/session.ts#L72) |
