...
4. **Configure Redirect URIs**
   ...
   <Note>
     This is the only redirect URI you need, including for native apps. React
     Native sign-in reuses this same callback and returns to your app through a
     deep link — see [React Native](/react-native#oauth-sign-in).
   </Note>
