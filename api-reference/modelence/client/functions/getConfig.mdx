...
Defined in: [src/config/client.ts:11](https://github.com/modelence/modelence/blob/77b2ece9e470bd518ec28a2f7c1346f10452ec29/packages/modelence/src/config/client.ts#L11)
