...
Defined in: [src/config/client.ts:11](https://github.com/modelence/modelence/blob/6f8d1a39ada0a9525dda9bbbcc98c153ce033f96/packages/modelence/src/config/client.ts#L11)
