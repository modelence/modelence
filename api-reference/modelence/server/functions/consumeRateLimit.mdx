...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/ebb9106a5c7399a853ce454edc4fa214969228e5/packages/modelence/src/rate-limit/rules.ts#L30)
