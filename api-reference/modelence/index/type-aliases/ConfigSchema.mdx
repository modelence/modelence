...
Defined in: [src/config/types.ts:17](https://github.com/modelence/modelence/blob/532bd9d6d1803acfaae9221933b66252aeb7e028/packages/modelence/src/config/types.ts#L17)
