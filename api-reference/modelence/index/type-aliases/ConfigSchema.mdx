...
Defined in: [src/config/types.ts:17](https://github.com/modelence/modelence/blob/05ac1b747aa6f2d488192772f7b7b9435623732b/packages/modelence/src/config/types.ts#L17)
