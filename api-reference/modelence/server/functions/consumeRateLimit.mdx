...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/92ab275a6df8ec055091fc4e374a06348f2cc99b/packages/modelence/src/rate-limit/rules.ts#L30)
