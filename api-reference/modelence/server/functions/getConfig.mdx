...
Defined in: [src/config/server.ts:43](https://github.com/modelence/modelence/blob/3775114b556752e79f78c614dc6f55f98ae68175/packages/modelence/src/config/server.ts#L43)
