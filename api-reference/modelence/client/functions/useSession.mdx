...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/58d9840d767e7a8a0d115fc2e0a7f7e6118771e6/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/58d9840d767e7a8a0d115fc2e0a7f7e6118771e6/packages/modelence/src/client/session.ts#L72) |
