...
function SectionRow({
  ...
  return (
    <div
      className={`flex py-8 border-b border-gray-200 dark:border-gray-800 ${className}`}
    >
      <div className="w-56 pr-6 text-gray-900 dark:text-white font-medium flex-shrink-0 flex items-start">
        {label}
      </div>
...
function ProfileContent({
  ...
  const name = profile.firstName || profile.handle.split("@")[0] || "No name";
  ...
  }[] = [
    {
      ...
      icon: (
        <svg width="20" height="20" fill="none" viewBox="0 0 20 20">
          ...
          />
          <path
            d="M2.5 17c0-2.485 3.358-4.5 7.5-4.5s7.5 2.015 7.5 4.5"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
          />
    ...
    tabs.push({
      ...
      icon: (
        <svg width="20" height="20" fill="none" viewBox="0 0 20 20">
          ...
          />
          <path
            d="M11.08 17.6h-2.16l-.6-1.84c-.4-.12-.8-.28-1.16-.48l-1.76.88-1.52-1.52.88-1.76c-.2-.36-.36-.76-.48-1.16L2.4 11.08v-2.16l1.84-.6c.12-.4.28-.8.48-1.16l-.88-1.76 1.52-1.52 1.76.88c.36-.2.76-.36 1.16-.48L8.92 2.4h2.16l.6 1.84c.4.12.8.28 1.16.48l1.76-.88 1.52 1.52-.88 1.76c.2.36.36.76.48 1.16l1.84.6v2.16l-1.84.6c-.12.4-.28.8-.48 1.16l.88 1.76-1.52 1.52-1.76-.88c-.36.2-.76.36-1.16.48l-.6 1.84z"
            stroke="currentColor"
            strokeWidth="1.5"
          />
        </svg>
      ...
      <aside className="w-64 border-r border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 rounded-l-xl flex flex-col py-8 px-6">
        ...
        <nav className="flex flex-col gap-2 mt-4">
          {tabs.map((tab) => (
            ...
            >
              <span className="inline-block w-5 text-center">{tab.icon}</span>
              {tab.label}
            </button>
          ))}
        </nav>
