...
Defined in: [packages/modelence/src/config/types.ts:17](https://github.com/modelence/modelence/blob/92ab275a6df8ec055091fc4e374a06348f2cc99b/packages/modelence/src/config/types.ts#L17)
