...
Defined in: [src/client/session.ts:94](https://github.com/modelence/modelence/blob/9e0957d9bf7628268c013ac4006f1ad6096028c9/packages/modelence/src/client/session.ts#L94)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:96](https://github.com/modelence/modelence/blob/9e0957d9bf7628268c013ac4006f1ad6096028c9/packages/modelence/src/client/session.ts#L96) |
