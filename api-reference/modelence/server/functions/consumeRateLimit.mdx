...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/eff60a49c5827e5240a61cdee9ad715a06ff3c04/packages/modelence/src/rate-limit/rules.ts#L30)
