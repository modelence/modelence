...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/6ff5a41600441b13f2799fb428b853edb011dbfb/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/6ff5a41600441b13f2799fb428b853edb011dbfb/packages/modelence/src/client/session.ts#L72) |
