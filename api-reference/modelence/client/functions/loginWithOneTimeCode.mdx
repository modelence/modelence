...
Defined in: [packages/modelence/src/auth/client/index.ts:235](https://github.com/modelence/modelence/blob/56c67773669490326fca501de70f5805db445ffb/packages/modelence/src/auth/client/index.ts#L235)
