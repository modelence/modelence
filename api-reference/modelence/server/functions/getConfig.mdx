...
Defined in: [src/config/server.ts:13](https://github.com/modelence/modelence/blob/a1cb59344fac2bf473f8529d63492778a3f0ca41/packages/modelence/src/config/server.ts#L13)
