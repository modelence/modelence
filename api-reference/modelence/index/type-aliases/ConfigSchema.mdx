...
Defined in: [src/config/types.ts:17](https://github.com/modelence/modelence/blob/bc64a11728f4732537606ba9a794e4e658e3320d/packages/modelence/src/config/types.ts#L17)
