...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/e86490d903eb3e60f85ca5d6d7afc0ef0b002e4b/packages/modelence/src/rate-limit/rules.ts#L30)
