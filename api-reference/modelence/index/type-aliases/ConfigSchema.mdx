...
Defined in: [packages/modelence/src/config/types.ts:17](https://github.com/modelence/modelence/blob/75299328dd370b54ff1971c3272898fcdf051ecb/packages/modelence/src/config/types.ts#L17)
