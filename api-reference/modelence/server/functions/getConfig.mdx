...
Defined in: [src/config/server.ts:13](https://github.com/modelence/modelence/blob/0bf07f03b7a21a8d33d2757e574bd629a1d4aa98/packages/modelence/src/config/server.ts#L13)
