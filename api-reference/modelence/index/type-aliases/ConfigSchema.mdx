...
Defined in: [packages/modelence/src/config/types.ts:81](https://github.com/modelence/modelence/blob/24ed11776f0d157e559834c800a9333d0af28f69/packages/modelence/src/config/types.ts#L81)
