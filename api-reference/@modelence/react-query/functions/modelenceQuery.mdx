...
Defined in: [index.ts:34](https://github.com/modelence/modelence/blob/d4cddd720cd27afa0b3acc864c0d8ac010ed448c/packages/react-query/src/index.ts#L34)
...
| ------ | ------ | ------ |
| `queryFn()` | () => `Promise`\<`T`\> | [index.ts:40](https://github.com/modelence/modelence/blob/d4cddd720cd27afa0b3acc864c0d8ac010ed448c/packages/react-query/src/index.ts#L40) |
| `queryKey` | (`string` \| `Args`)[] | [index.ts:39](https://github.com/modelence/modelence/blob/d4cddd720cd27afa0b3acc864c0d8ac010ed448c/packages/react-query/src/index.ts#L39) |
