...
Defined in: [index.ts:108](https://github.com/modelence/modelence/blob/f88b8e36b7462350566e0fb104dcb2beb7d8bbdb/packages/react-query/src/index.ts#L108)
...
| ------ | ------ | ------ |
| `queryFn()` | () => `Promise`\<`T`\> | [index.ts:114](https://github.com/modelence/modelence/blob/f88b8e36b7462350566e0fb104dcb2beb7d8bbdb/packages/react-query/src/index.ts#L114) |
| `queryKey` | (`string` \| `Args`)[] | [index.ts:113](https://github.com/modelence/modelence/blob/f88b8e36b7462350566e0fb104dcb2beb7d8bbdb/packages/react-query/src/index.ts#L113) |
