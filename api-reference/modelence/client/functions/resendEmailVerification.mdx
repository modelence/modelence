...
Defined in: [packages/modelence/src/auth/client/index.ts:80](https://github.com/modelence/modelence/blob/d1690b74f3d3d5732fecc24f2e35a3297f407279/packages/modelence/src/auth/client/index.ts#L80)
