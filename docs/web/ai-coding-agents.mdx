...
Next.js app. How such a project is built and run is described in a `modelence.json` file at its root,
and your agent is the right one to write it, since it knows the codebase. Give it the
