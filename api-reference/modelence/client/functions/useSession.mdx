...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/2f1df56b3cc9110e2382a3eeaeda390e4768d689/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/2f1df56b3cc9110e2382a3eeaeda390e4768d689/packages/modelence/src/client/session.ts#L72) |
