...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/d5c19b43db21431ca4e51dd35b456b52958109c5/packages/modelence/src/rate-limit/rules.ts#L30)
