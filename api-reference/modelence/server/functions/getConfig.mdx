...
Defined in: [src/config/server.ts:13](https://github.com/modelence/modelence/blob/62259b6697571b616c549c71583a3c319522198d/packages/modelence/src/config/server.ts#L13)
