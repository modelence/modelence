...
Defined in: [src/auth/client/index.ts:86](https://github.com/modelence/modelence/blob/d30ed598c2e55606289379715fe783003cafb19f/packages/modelence/src/auth/client/index.ts#L86)
