...
Defined in: [src/config/types.ts:17](https://github.com/modelence/modelence/blob/65574a486d729b2a5e8e460d4cb1ff9efb109906/packages/modelence/src/config/types.ts#L17)
