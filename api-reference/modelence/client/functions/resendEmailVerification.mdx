...
Defined in: [packages/modelence/src/auth/client/index.ts:80](https://github.com/modelence/modelence/blob/ebb9106a5c7399a853ce454edc4fa214969228e5/packages/modelence/src/auth/client/index.ts#L80)
