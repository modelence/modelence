...
Defined in: [packages/modelence/src/auth/client/index.ts:143](https://github.com/modelence/modelence/blob/99f3f0cf7f32f7c10ec35742a256056bd06f8a8d/packages/modelence/src/auth/client/index.ts#L143)
