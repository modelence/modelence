...
Defined in: [packages/modelence/src/auth/client/index.ts:271](https://github.com/modelence/modelence/blob/60e8613fb64cecdf518d1bc0c8824c2abed99ac9/packages/modelence/src/auth/client/index.ts#L271)
