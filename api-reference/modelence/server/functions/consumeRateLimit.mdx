...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/2c69ba4c83116f3cc51a1f05b0527e5478bd3dcb/packages/modelence/src/rate-limit/rules.ts#L30)
