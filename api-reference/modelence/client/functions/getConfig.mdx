...
Defined in: [packages/modelence/src/config/client.ts:11](https://github.com/modelence/modelence/blob/e86490d903eb3e60f85ca5d6d7afc0ef0b002e4b/packages/modelence/src/config/client.ts#L11)
