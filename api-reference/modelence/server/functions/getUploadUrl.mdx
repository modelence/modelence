...
Defined in: [packages/modelence/src/files/index.ts:14](https://github.com/modelence/modelence/blob/2a1cfea37cbb50cb313be0936e77f11da5319246/packages/modelence/src/files/index.ts#L14)
