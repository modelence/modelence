...
Defined in: [packages/modelence/src/auth/client/index.ts:135](https://github.com/modelence/modelence/blob/23aa2dbc912a35032932dd7160886d9adee5e9d4/packages/modelence/src/auth/client/index.ts#L135)
