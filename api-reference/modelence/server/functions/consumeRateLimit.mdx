...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/f73c05af956b345dde3084f8fc63e7abd2668c96/packages/modelence/src/rate-limit/rules.ts#L30)
