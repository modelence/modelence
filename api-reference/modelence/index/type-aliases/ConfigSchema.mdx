...
Defined in: [src/config/types.ts:17](https://github.com/modelence/modelence/blob/479eb8fe96a16700018474b094fd04ee55c77fcc/packages/modelence/src/config/types.ts#L17)
