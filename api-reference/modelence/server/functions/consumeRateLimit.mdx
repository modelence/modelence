...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/7e820eafb2160b12dfdecec9c309ad18efc88493/packages/modelence/src/rate-limit/rules.ts#L30)
