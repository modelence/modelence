...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/479eb8fe96a16700018474b094fd04ee55c77fcc/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/479eb8fe96a16700018474b094fd04ee55c77fcc/packages/modelence/src/client/session.ts#L72) |
