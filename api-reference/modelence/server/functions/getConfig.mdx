...
Defined in: [src/config/server.ts:43](https://github.com/modelence/modelence/blob/e70c7e758bc5ad185d771fba4dfe02d30281b93a/packages/modelence/src/config/server.ts#L43)
