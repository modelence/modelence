...
Defined in: [src/auth/client/index.ts:86](https://github.com/modelence/modelence/blob/90c266574333430bd7e5eb1b19555ddac1006208/packages/modelence/src/auth/client/index.ts#L86)
