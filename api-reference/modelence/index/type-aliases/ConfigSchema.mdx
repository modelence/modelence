...
Defined in: [src/config/types.ts:17](https://github.com/modelence/modelence/blob/d30ed598c2e55606289379715fe783003cafb19f/packages/modelence/src/config/types.ts#L17)
