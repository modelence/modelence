...
| ------ | ------ | ------ | ------ |
| <a id="limit"></a> `limit` | `number` | Maximum allowed hits within the window. | [packages/modelence/src/app/authConfig.ts:27](https://github.com/modelence/modelence/blob/f614ecc6811cdda9670d612872c8ff49a49c5e28/packages/modelence/src/app/authConfig.ts#L27) |
...
| <a id="window"></a> `window` | `number` | Time window size in milliseconds. Use `time.minutes(15)` etc. | [packages/modelence/src/app/authConfig.ts:25](https://github.com/modelence/modelence/blob/f614ecc6811cdda9670d612872c8ff49a49c5e28/packages/modelence/src/app/authConfig.ts#L25) |
