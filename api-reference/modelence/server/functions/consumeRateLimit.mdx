...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/a33e01dffb7e1c39a5fedd0cd9b7ccf679248cfe/packages/modelence/src/rate-limit/rules.ts#L30)
