...
Defined in: [src/config/types.ts:17](https://github.com/modelence/modelence/blob/f23cf83a908dbf7a8a66b82b7fa717482b3bcd9a/packages/modelence/src/config/types.ts#L17)
