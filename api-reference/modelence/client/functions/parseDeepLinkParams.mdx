...
Defined in: [packages/modelence/src/auth/client/deepLink.ts:18](https://github.com/modelence/modelence/blob/3b6a190f995ee5c5159abbd5fe2c13810b80ef06/packages/modelence/src/auth/client/deepLink.ts#L18)
