...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/2e721459f75ba11a220137d4df59b619a82a0068/packages/modelence/src/rate-limit/rules.ts#L30)
