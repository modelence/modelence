...
Defined in: [packages/modelence/src/config/server.ts:43](https://github.com/modelence/modelence/blob/6023a52d93b5edf0877a33ac51ab9d46ca8d2f4c/packages/modelence/src/config/server.ts#L43)
