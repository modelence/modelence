...
Defined in: [index.ts:108](https://github.com/modelence/modelence/blob/e1584e809395c5c1594b416da484f67ec425873b/packages/react-query/src/index.ts#L108)
...
| ------ | ------ | ------ |
| `queryFn()` | () => `Promise`\<`T`\> | [index.ts:114](https://github.com/modelence/modelence/blob/e1584e809395c5c1594b416da484f67ec425873b/packages/react-query/src/index.ts#L114) |
| `queryKey` | (`string` \| `Args`)[] | [index.ts:113](https://github.com/modelence/modelence/blob/e1584e809395c5c1594b416da484f67ec425873b/packages/react-query/src/index.ts#L113) |
