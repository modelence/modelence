...
Defined in: [src/client/session.ts:94](https://github.com/modelence/modelence/blob/3f1fd635e8381fab6218a1a4e54da43042986b70/packages/modelence/src/client/session.ts#L94)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:96](https://github.com/modelence/modelence/blob/3f1fd635e8381fab6218a1a4e54da43042986b70/packages/modelence/src/client/session.ts#L96) |
