---
title: 'Live Queries'
description: 'Real-time data synchronization with automatic updates using LiveData and TanStack Query. Available since modelence@0.10.1 and @modelence/react-query@1.2.1.'
icon: 'rotate'
---
