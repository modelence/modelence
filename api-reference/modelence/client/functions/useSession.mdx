...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/da8a100236747cbb5f621659811bb90f0af239d7/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/da8a100236747cbb5f621659811bb90f0af239d7/packages/modelence/src/client/session.ts#L72) |
