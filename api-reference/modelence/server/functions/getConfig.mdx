...
Defined in: [packages/modelence/src/config/server.ts:43](https://github.com/modelence/modelence/blob/978ee26c6a4b8707272de7628cef6c5f400cf81b/packages/modelence/src/config/server.ts#L43)
