...
Defined in: [packages/modelence/src/config/client.ts:11](https://github.com/modelence/modelence/blob/95097a0b2f0cfaa7c23437950aa39529f09ed4ff/packages/modelence/src/config/client.ts#L11)
