...
Defined in: [packages/modelence/src/auth/client/index.ts:186](https://github.com/modelence/modelence/blob/ba7a070d08a2cc6f91695d5a1e5d0a71f785d7b2/packages/modelence/src/auth/client/index.ts#L186)
