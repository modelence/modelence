...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/6b6eda946abd670256ebc7c5dcb89887e0df567d/packages/modelence/src/rate-limit/rules.ts#L30)
