...
Defined in: [packages/modelence/src/rate-limit/rules.ts:29](https://github.com/modelence/modelence/blob/458a34c72cf078264dccea8c85b21ffa16d37642/packages/modelence/src/rate-limit/rules.ts#L29)
