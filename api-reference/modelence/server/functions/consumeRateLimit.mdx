...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/8245dc2c98f40708182745e583c433ccc730c549/packages/modelence/src/rate-limit/rules.ts#L30)
