...
Defined in: [src/config/server.ts:13](https://github.com/modelence/modelence/blob/72580191dccfb1a9a42664d6f05e82daf7d86019/packages/modelence/src/config/server.ts#L13)
