...
Defined in: [src/rate-limit/rules.ts:29](https://github.com/modelence/modelence/blob/d4cddd720cd27afa0b3acc864c0d8ac010ed448c/packages/modelence/src/rate-limit/rules.ts#L29)
