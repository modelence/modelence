...
Defined in: [src/config/types.ts:17](https://github.com/modelence/modelence/blob/0b6733f929d9a9924993eb740aa6cd4a165aa17c/packages/modelence/src/config/types.ts#L17)
