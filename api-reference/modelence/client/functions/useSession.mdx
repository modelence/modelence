...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/df0c5788435c8faa0f8712932d26a40268a9218f/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/df0c5788435c8faa0f8712932d26a40268a9218f/packages/modelence/src/client/session.ts#L72) |
