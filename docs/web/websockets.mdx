...
- **WebsocketServerProvider** - Interface for WebSocket server providers ([API Reference](/api-reference/modelence/index/interfaces/WebsocketServerProvider))
- **ServerChannel** - Server-side channel class ([API Reference](/api-reference/modelence/server/classes/ServerChannel))

### Client Types

- **WebsocketClientProvider** - Interface for WebSocket client providers ([API Reference](/api-reference/modelence/index/interfaces/WebsocketClientProvider))
- **ClientChannel** - Client-side channel class ([API Reference](/api-reference/modelence/client/classes/ClientChannel))

### Functions

- **startWebsockets** - Initialize WebSocket connection ([API Reference](/api-reference/modelence/client/functions/startWebsockets))
- **broadcast** - Send message to all clients in a channel ([ServerChannel API Reference](/api-reference/modelence/server/classes/ServerChannel))
- **joinChannel** - Join a specific channel ([ClientChannel API Reference](/api-reference/modelence/client/classes/ClientChannel))
- **leaveChannel** - Leave a specific channel ([ClientChannel API Reference](/api-reference/modelence/client/classes/ClientChannel))
