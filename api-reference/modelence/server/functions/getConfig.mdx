...
Defined in: [src/config/server.ts:46](https://github.com/modelence/modelence/blob/5a43bca087f9c3d4223f83f5e962ea79c59da20b/packages/modelence/src/config/server.ts#L46)
