...
Defined in: [packages/modelence/src/config/client.ts:19](https://github.com/modelence/modelence/blob/02e3d66d43fe1a8f91de9f211d0d5da3708ef661/packages/modelence/src/config/client.ts#L19)
