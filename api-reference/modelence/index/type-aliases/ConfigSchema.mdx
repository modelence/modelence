...
Defined in: [packages/modelence/src/config/types.ts:81](https://github.com/modelence/modelence/blob/161587a066fb21d77222dd04dcd85906356142d2/packages/modelence/src/config/types.ts#L81)
