...
Defined in: [src/config/server.ts:13](https://github.com/modelence/modelence/blob/a4ef5338554e9e118a965eaf4a3d462dacf27d86/packages/modelence/src/config/server.ts#L13)
