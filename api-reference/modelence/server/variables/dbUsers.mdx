...
Defined in: [packages/modelence/src/auth/db.ts:18](https://github.com/modelence/modelence/blob/2a1cfea37cbb50cb313be0936e77f11da5319246/packages/modelence/src/auth/db.ts#L18)
