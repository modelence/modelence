...
Defined in: [src/config/server.ts:13](https://github.com/modelence/modelence/blob/dc7829b85ab8bfbdeb8a493bb7737f1b0d315352/packages/modelence/src/config/server.ts#L13)
