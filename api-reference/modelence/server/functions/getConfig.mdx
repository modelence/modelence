...
Defined in: [src/config/server.ts:43](https://github.com/modelence/modelence/blob/d60022afccb1a974b729cb4aaaf48ac10f9a4601/packages/modelence/src/config/server.ts#L43)
