...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/5a179d0f134bc8967dbdf2f7ec99fc0b0f17d49c/packages/modelence/src/rate-limit/rules.ts#L30)
