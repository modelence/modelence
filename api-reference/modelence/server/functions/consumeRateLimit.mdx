...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/9f2ac29feebd5bf4df842b642b9537d004dffd85/packages/modelence/src/rate-limit/rules.ts#L30)
