 ...
 */
export function generateAutoModulesContent(modules: ScannedModule[]): string {
  if (modules.length === 0) {
    return [
      '// Auto-generated by Modelence. Do not edit.',
      `import { setAutoLoadedModules } from 'modelence/server';`,
      '',
      'setAutoLoadedModules([]);',
      '',
    ].join('\n');
  }
  ...
  const lines: string[] = [
    '// Auto-generated by Modelence. Do not edit.',
    `import { Module, setAutoLoadedModules } from 'modelence/server';`,
    '',
  ];
...
export async function generateAutoLoadFiles(serverDir: string, serverEntry: string): Promise<void> {
  ...
  const autoModulesContent = generateAutoModulesContent(modules);
