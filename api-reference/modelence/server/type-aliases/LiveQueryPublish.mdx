...
Defined in: [packages/modelence/src/live-query/context.ts:5](https://github.com/modelence/modelence/blob/c1dd758b5946bfeb65e0350e43462a34def42c3b/packages/modelence/src/live-query/context.ts#L5)
