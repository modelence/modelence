...
Defined in: [src/config/server.ts:43](https://github.com/modelence/modelence/blob/b983bd596c065de0b3196190ccfffab8dc768932/packages/modelence/src/config/server.ts#L43)
