...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/7a30ecd22bee851ae2925fe6ba92db76a4d9e1d2/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/7a30ecd22bee851ae2925fe6ba92db76a4d9e1d2/packages/modelence/src/client/session.ts#L72) |
