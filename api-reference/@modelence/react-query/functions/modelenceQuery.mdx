...
Defined in: [index.ts:108](https://github.com/modelence/modelence/blob/161587a066fb21d77222dd04dcd85906356142d2/packages/react-query/src/index.ts#L108)
...
| ------ | ------ | ------ |
| `queryFn()` | () => `Promise`\<`T`\> | [index.ts:114](https://github.com/modelence/modelence/blob/161587a066fb21d77222dd04dcd85906356142d2/packages/react-query/src/index.ts#L114) |
| `queryKey` | (`string` \| `Args`)[] | [index.ts:113](https://github.com/modelence/modelence/blob/161587a066fb21d77222dd04dcd85906356142d2/packages/react-query/src/index.ts#L113) |
