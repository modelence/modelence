...
description: 'Send transactional emails out of the box, or plug in your own provider'
---
...
- Outbound mail is relayed through Modelence Cloud (`/api/email/send`), which sends via Amazon SES on a Modelence-owned domain.
- The sender domain is locked to a Modelence subdomain in v1 — you do not need to verify a domain to start sending.
