...
Defined in: [src/client/session.ts:94](https://github.com/modelence/modelence/blob/a98c06449c1342b806775f739bd458d3c703b83e/packages/modelence/src/client/session.ts#L94)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:96](https://github.com/modelence/modelence/blob/a98c06449c1342b806775f739bd458d3c703b83e/packages/modelence/src/client/session.ts#L96) |
