...
Defined in: [src/config/server.ts:13](https://github.com/modelence/modelence/blob/9e0957d9bf7628268c013ac4006f1ad6096028c9/packages/modelence/src/config/server.ts#L13)
