...
Defined in: [src/client/session.ts:94](https://github.com/modelence/modelence/blob/35d8bc2685ef485e261064cb30d0318e5214971b/packages/modelence/src/client/session.ts#L94)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:96](https://github.com/modelence/modelence/blob/35d8bc2685ef485e261064cb30d0318e5214971b/packages/modelence/src/client/session.ts#L96) |
