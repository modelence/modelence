...
Defined in: [packages/modelence/src/client/clientConfig.ts:58](https://github.com/modelence/modelence/blob/1e9ff395f60f475313a797050277f80af6a46693/packages/modelence/src/client/clientConfig.ts#L58)
