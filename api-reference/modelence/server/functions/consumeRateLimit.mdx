...
Defined in: [packages/modelence/src/rate-limit/rules.ts:30](https://github.com/modelence/modelence/blob/14ebc3db65dcd48c2b23e11381e514806b266df9/packages/modelence/src/rate-limit/rules.ts#L30)
