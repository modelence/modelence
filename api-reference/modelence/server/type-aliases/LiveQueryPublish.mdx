...
Defined in: [packages/modelence/src/live-query/context.ts:5](https://github.com/modelence/modelence/blob/23aa2dbc912a35032932dd7160886d9adee5e9d4/packages/modelence/src/live-query/context.ts#L5)
