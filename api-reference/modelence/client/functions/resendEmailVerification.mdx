...
Defined in: [packages/modelence/src/auth/client/index.ts:80](https://github.com/modelence/modelence/blob/222809af335ee4693498716e629b8f44db133d59/packages/modelence/src/auth/client/index.ts#L80)
