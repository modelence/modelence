...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/7d5ab6803a03a590fa9ba44d3ce0544ecf5463af/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/7d5ab6803a03a590fa9ba44d3ce0544ecf5463af/packages/modelence/src/client/session.ts#L72) |
