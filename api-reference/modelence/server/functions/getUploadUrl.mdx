...
Defined in: [packages/modelence/src/files/index.ts:14](https://github.com/modelence/modelence/blob/1cba4febffc6e13a76a88a761cd2db3c4ec0da1e/packages/modelence/src/files/index.ts#L14)
