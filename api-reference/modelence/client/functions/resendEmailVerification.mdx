...
Defined in: [packages/modelence/src/auth/client/index.ts:80](https://github.com/modelence/modelence/blob/59db0b27e3cedcbf9075d368046287e413909709/packages/modelence/src/auth/client/index.ts#L80)
