...
Defined in: [packages/modelence/src/live-query/context.ts:5](https://github.com/modelence/modelence/blob/15f8611bcd6349c16f3ccb839fcc035d5d7e72ae/packages/modelence/src/live-query/context.ts#L5)
