...
Defined in: [index.ts:108](https://github.com/modelence/modelence/blob/e774b67fbbc6b048bc012fe1dc2555e710829b00/packages/react-query/src/index.ts#L108)
...
| ------ | ------ | ------ |
| `queryFn()` | () => `Promise`\<`T`\> | [index.ts:114](https://github.com/modelence/modelence/blob/e774b67fbbc6b048bc012fe1dc2555e710829b00/packages/react-query/src/index.ts#L114) |
| `queryKey` | (`string` \| `Args`)[] | [index.ts:113](https://github.com/modelence/modelence/blob/e774b67fbbc6b048bc012fe1dc2555e710829b00/packages/react-query/src/index.ts#L113) |
