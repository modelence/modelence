...
Defined in: [packages/modelence/src/auth/client/index.ts:80](https://github.com/modelence/modelence/blob/ddd1b06ebdaf4c401e60d0cd9067ed37e062c96b/packages/modelence/src/auth/client/index.ts#L80)
