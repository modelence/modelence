...
Defined in: [packages/modelence/src/rate-limit/rules.ts:29](https://github.com/modelence/modelence/blob/235bb8a67bcbdab2ed8a82bca53ae0c950ff4660/packages/modelence/src/rate-limit/rules.ts#L29)
