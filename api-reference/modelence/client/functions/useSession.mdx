...
Defined in: [src/client/session.ts:70](https://github.com/modelence/modelence/blob/92e8ef3b8e17265b22cb987ecf6083303a9d1782/packages/modelence/src/client/session.ts#L70)
...
| ------ | ------ | ------ |
| `user` | `null` \| `User` | [src/client/session.ts:72](https://github.com/modelence/modelence/blob/92e8ef3b8e17265b22cb987ecf6083303a9d1782/packages/modelence/src/client/session.ts#L72) |
