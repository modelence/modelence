...
Defined in: [packages/modelence/src/config/types.ts:17](https://github.com/modelence/modelence/blob/e21088847e4caea85e78553020655f7e3a484410/packages/modelence/src/config/types.ts#L17)
