...
Defined in: [packages/modelence/src/auth/client/index.ts:80](https://github.com/modelence/modelence/blob/c6eb622fc7b8d1f12955379f26a1317deda6e151/packages/modelence/src/auth/client/index.ts#L80)
