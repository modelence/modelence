...
Defined in: [index.ts:108](https://github.com/modelence/modelence/blob/e70c7e758bc5ad185d771fba4dfe02d30281b93a/packages/react-query/src/index.ts#L108)
...
| ------ | ------ | ------ |
| `queryFn()` | () => `Promise`\<`T`\> | [index.ts:114](https://github.com/modelence/modelence/blob/e70c7e758bc5ad185d771fba4dfe02d30281b93a/packages/react-query/src/index.ts#L114) |
| `queryKey` | (`string` \| `Args`)[] | [index.ts:113](https://github.com/modelence/modelence/blob/e70c7e758bc5ad185d771fba4dfe02d30281b93a/packages/react-query/src/index.ts#L113) |
