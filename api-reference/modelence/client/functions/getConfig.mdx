...
Defined in: [src/config/client.ts:11](https://github.com/modelence/modelence/blob/7e5aaad36b6290854f32f400608c1fe022c3eb0b/packages/modelence/src/config/client.ts#L11)
